...
CRON_JOB="*/10 * * * * /usr/bin/python3 /root/shiny-server/apps/sample-apps/00_wondercat/fetchData.py >> /root/shiny-server/apps/sample-apps/00_wondercat/execution_logs/cron_log.txt 2>&1"
