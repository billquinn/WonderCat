...
dataframe <- read_csv(paste0(getwd(), "/wonderCat.csv"), col_names = TRUE)
# colnames(data) <- c(
#       'id', 'author', 'date', 'benefit', 'experience', 'technology', 'text', 'QID', 'title'
#     )

# wikiResp <- get_wikidata(dataframe)
wikiResp <- read_csv(paste0(getwd(), "/wikiData.csv"), col_names = TRUE)
# colnames(wikiResp) <- c(
